...
class ReplacePagesResult(PDFServicesJobResult):
    """
    This class encapsulates the result of
    :class:`ReplacePagesJob<adobe.pdfservice.operation.pdfjobs.jobs.replace_pages_job.ReplacePagesJob>`
    """

    def __init__(self, asset: Asset):
        """
        Constructs a new :samp:`ReplacePagesResult` instance.
