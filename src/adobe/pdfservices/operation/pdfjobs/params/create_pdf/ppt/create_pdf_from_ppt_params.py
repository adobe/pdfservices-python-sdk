...
from adobe.pdfservices.operation.pdfjobs.params.create_pdf.ppt.document_language import DocumentLanguage


class CreatePDFFromPPTParams(CreatePDFParams):

    @enforce_types
    def __init__(self, *, document_language: DocumentLanguage = DocumentLanguage.EN_US,
                 create_tagged_pdf: bool = False):
        """
        Constructs a new instance of :samp:`CreatePDFFromPPTParams`.
