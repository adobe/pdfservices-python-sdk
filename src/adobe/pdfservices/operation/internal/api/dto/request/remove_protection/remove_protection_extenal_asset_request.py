...
from adobe.pdfservices.operation.internal.api.dto.request.remove_protection.remove_protection_params_payload import \
    RemoveProtectionParamsPayload
...
class RemoveProtectionExternalAssetRequest(PDFServicesAPIRequest):
    json_hint = {
        'input': 'input',
        'output': 'output',
        'params': 'params',
    ...
    def __init__(self, input_asset: Asset, remove_protection_params: RemoveProtectionParams,
        ...
        self.params: RemoveProtectionParamsPayload = RemoveProtectionParamsPayload(remove_protection_params)
