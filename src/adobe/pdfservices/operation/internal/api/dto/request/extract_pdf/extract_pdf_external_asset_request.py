...
from adobe.pdfservices.operation.internal.api.dto.request.extract_pdf.extract_pdf_params_payload import \
    ExtractPDFParamsPayload
...
class ExtractPDFExternalAssetRequest(PDFServicesAPIRequest):
    json_hint = {
        'input': 'input',
        'output': 'output',
        'params': 'params',
    ...
    def __init__(self, input_asset: Asset, extract_pdf_params: ExtractPDFParams,
        ...
        if extract_pdf_params is not None:
            self.params = ExtractPDFParamsPayload(extract_pdf_params)
