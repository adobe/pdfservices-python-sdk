...
from adobe.pdfservices.operation.internal.api.dto.request.pdftoimage.pdf_to_image_params_payload import \
    PDFtoImageParamsPayload
...
class PDFtoImagesExternalAssetRequest(PDFServicesAPIRequest):
    json_hint = {
        'input': 'input',
        'output': 'output',
        'params': 'params',
    ...
    def __init__(self, input_asset: Asset, export_pdf_to_images_params: ExportPDFtoImagesParams,
        ...
        self.params: ExportPDFtoImagesParams = PDFtoImageParamsPayload(export_pdf_to_images_params)
