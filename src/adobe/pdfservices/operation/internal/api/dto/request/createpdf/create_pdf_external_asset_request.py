...
from adobe.pdfservices.operation.internal.api.dto.request.createpdf.create_pdf_params_payload import \
    CreatePDFParamsPayload
...
class CreatePDFExternalAssetRequest(PDFServicesAPIRequest):
    json_hint = {
        'input': 'input',
        'output': 'output',
        'params': 'params',
    ...
    def __init__(self, input_asset: Asset, create_pdf_params: CreatePDFParams,
        ...
        self.params: CreatePDFParamsPayload = CreatePDFParamsPayload(create_pdf_params)
