...
class SplitPDFInternalAssetRequest(PDFServicesAPIRequest):
    json_hint = {
        'asset_id': 'assetID',
        'split_pdf_params': 'splitoption',
        'notify_config_list': 'notifiers'
    }

    def __init__(self, asset_id: str, split_pdf_params: SplitPDFParams,
                 notify_config_list: List[NotifierConfig] = None):
        super().__init__()
        self.asset_id = asset_id
        self.split_pdf_params = split_pdf_params
