...
from adobe.pdfservices.operation.internal.api.dto.request.pagemanipulation.page_action_commands import \
    PageActionCommands
from adobe.pdfservices.operation.internal.api.dto.request.pagemanipulation.page_manipulation_params_payload import \
...
class PageManipulationExternalAssetRequest(PDFServicesAPIRequest):
    json_hint = {
        'input': 'input',
        'output': 'output',
        'params': 'params',
    ...
    def __init__(self, input_asset: Asset, page_action_commands: PageActionCommands,
        ...
        self.params = PageManipulationParamsPayload(page_action_commands)
