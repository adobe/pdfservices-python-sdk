...
class ExtractPDFParams(InlineParams):
    ...
    def __init__(self, elements_to_extract: List[PDFElementType] = None,
                 renditions_to_extract: List[PDFElementType] = None, table_output_format: TableStructureType = None,
                 extract_char_info: bool = None):
        super().__init__()
    ...
    def from_extract_pdf_options(cls, extract_pdf_options: ExtractPDFOptions = None):
        if extract_pdf_options:
            ...
            return cls(elements_to_extract=[PDFElementType.TEXT])
