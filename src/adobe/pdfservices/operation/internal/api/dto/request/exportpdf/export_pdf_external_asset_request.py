...
from adobe.pdfservices.operation.internal.api.dto.request.exportpdf.export_pdf_params_payload import \
    ExportPDFParamsPayload
...
class ExportPDFExternalAssetRequest(PDFServicesAPIRequest):
    json_hint = {
        'input': 'input',
        'output': 'output',
        'params': 'params',
    ...
    def __init__(self, input_asset: Asset, export_pdf_params: ExportPDFParams,
        ...
        self.params: ExportPDFParamsPayload = ExportPDFParamsPayload(export_pdf_params)
